...
class Manage_article extends Controller {
	...
	function load_article() {
		...
		$data_article['main_view'] 			= 'editor/manage_article_view';
		$data_article['form_action']		= site_url('editor/manage_article/add_article');
		$data_article['form_action_search']	= site_url('editor/manage_article/search_article');		
		$data_article['form_action_adv']	= site_url('editor/manage_article/advance_search');
		$data_article['form_action_edit']	= site_url('editor/manage_article/edit_article');
		...
		// Membuat pagination			
		$config['base_url']    		= site_url('editor/manage_article/load_article/');
		...
		$this->load->view('editor/template', $data_article);
	}
	
	function detail_article($id_article) {
		$data_article['page_title']	 		= 'Detail Article |  News Basket';
		$data_article['main_view'] 	 		= 'editor/detail/article_detail_view';
		$data_article['article_property']	= 'editor/detail/article_detail_property';
		$link_manage_article				= site_url('editor/manage_article');
		$data_article['breadcrumb']			= "<a href='$link_manage_article' style='color: white;'>Manage Article</a> > Article Detail";
		$data_article['form_action_edit']	= site_url('editor/manage_article/edit_article').'/'.$id_article;
	...
	function add_article() {
		...
		$data_article['main_view']			= 'editor/form/add_article_form';
		$link_manage_article				= site_url('editor/manage_article');
		$data_article['breadcrumb']			= "<a href='$link_manage_article' style='color: white;'>Manage Article</a>
											   > Add  New Article";		
		$data_article['form_action_add']	= site_url('editor/manage_article/add_article_process');
		...
		if ((($this->session->userdata('user_level') == 'editor') || ($this->session->userdata('user_level') == 'editor')) && $this->session->userdata('login') == TRUE) {
			...
			if ($this->session->userdata('user_level') == 'editor') {
				$activity_log = array(
			...
			redirect('editor/manage_article');
		}
		else {
	...
	function edit_article($id_article) { 
		...
		$data_article['main_view'] 	 		= 'editor/detail/article_detail_view';
		$data_article['edit_article_form']	= 'editor/form/edit_article_form';
		$link_manage_article				= site_url('editor/manage_article');
		$link_detail_article				= site_url('editor/manage_article/detail_article').'/'.$id_article;
		$data_article['breadcrumb']			= "<a href='$link_manage_article' style='color: white;'>Manage Article</a>
											   > Edit Article";
		$data_article['form_action_edit']	= site_url('editor/manage_article/edit_article_process').'/'.$id_article;
		...
		if ($this->session->userdata('login') == TRUE && $this->session->userdata('user_level') == 'editor' && $this->Article_model->checkLockArticle($id_article) == TRUE) {
			//lock article
		...
		?>
			...
			document.location='<?php echo site_url('editor/manage_article')?>';
			</script>
			<?php
		}
	}
	...
	function edit_article_process() {
		if ((($this->session->userdata('user_level') == 'editor') || ($this->session->userdata('user_level') == 'editor')) && $this->session->userdata('login') == TRUE) {
			...
			$this->session->set_flashdata('message_success', $message);
			redirect('editor/manage_article/detail_article'.'/'.$id_article);
		}
		else {
	...
	function search_article($start = 0) {
		$data_article['page_title']			= 'Search Article | Editor News Basket';
		$data_article['main_view'] 			= 'editor/extra/search_article_view';
		$data_article['form_action_search']	= site_url('editor/manage_article/search_article');
		$data_article['form_action_adv']	= site_url('editor/manage_article/advance_search');
		...
		// Membuat pagination			
		$config['base_url']    = site_url('editor/manage_article/search_article');
		...
		// Membuat pagination			
		$config['base_url']    = site_url('editor/manage_article/advance_search');
		$config['total_rows']  = $data_article['count'];
		$config['per_page']    = $this->limit_search;
		$config['num_links']   = 4;
		$config['uri_segment'] = $uri_segment;
...
/* Location: ./system/application/controllers/editor/manage_article.php */