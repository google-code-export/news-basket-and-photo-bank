	...
	<table style="margin-left: 3px;">
		...
		<tr>
			...
			<td align="right">
				...
				<button class="btn-cancel-edit" onclick="location.href='<?php echo site_url('user/manage_user/detail_user'.'/'.$user['id_user']);?>'" type="button">Cancel</button>
			</td>
		</tr>
	</table>
	<table>
		*Leave blank if not replaced</table>
</form>