<h2>
	<a href="<?php echo site_url('editor/manage_article');?>" style="color: white;">Manage Article</a> > Search Article
	...
	<?php
		...
		if (!empty($result) && $count != 0) {
			...
			foreach($result as $column) {
				$headline = anchor(
					'editor/manage_article/detail_article/'.$column->id_article,
					$column->headline,
