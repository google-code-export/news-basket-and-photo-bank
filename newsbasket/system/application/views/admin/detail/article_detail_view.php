	...
	<div id="property" class="detail-left">
		...
		<table>
			...
			<tr>	
				...
				<td class="label"><p id="author-by"> </p></td>
			</tr>
			<tr>
				<td class="bold"><label for="edited-by">Editor</label></td>
				<td class="label"><p id="edited-by"> </p></td>
			</tr>	
			<tr>
			...
			<tr>
				...
				<td class="label"><p id="flag"><?php echo $article['flag']?></p></td>
			</tr>
		</table>
	</div>
