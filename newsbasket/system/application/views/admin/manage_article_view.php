<h2>Manage Article<button class="btn-add" style="float: right; height: 30px; margin-top: -2px;">+ Add New Article</button></h2>
		...
		<table id="zebra">
			...
			<?php
				...
				foreach ($article_table as $column) {
					...
					$editLink = anchor(
						'admin/manage_article/editArticle/'.$column->id_article,
						'<button>Edit</button>',
