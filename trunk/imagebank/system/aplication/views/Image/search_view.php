<div class="search-result"><h3>	<?php echo (!empty($images))? " search  result for <b>'$key'</b>  ($first_result - $last_result from $count image found) :" : "> No Results.";?>
</h3>
</div>
...
<div id="search-result" style="height:480px; overflow-y:auto ">
	...
	if (!empty($images) && $count != 0 && $key != null){
