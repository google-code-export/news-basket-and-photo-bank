<div class="main content clearfix">
	<img src="<?php echo base_url().'images/logo image bank.png';?>" width="160" style="float: right; position: absolute; z-index: 1; top: 4px; left:10px;">
	<img src="<?php echo base_url().'images/title.png';?>" width="350" style="float: right; position: absolute; z-index: 1; top: 45px; left:250px;">
			<div class="slideshow">
			<head>
...
<body>
<div id="SlideShow2" style="position:absolute;left:193px;top:165px;width:455px;height:255px;overflow:hidden;border:5px #1E1E1E solid;z-index:0;">
