...
<body>
<div id="container">
<div id="wb_sidebar" style="position:absolute;left:0px;top:102px;width:204px;height:547px;z-index:0;">
<img src="../images/img0007.gif" id="sidebar" alt=""></div>
...
<img src="../images/logo%20image%20bank.png" id="Image1" alt="" border="0" style="width:197px;height:68px;"></div>
...
<button id="AdvancedButton1" type="button" name="" value="" style="position:absolute;left:223px;top:190px;width:84px;height:24px;z-index:7;"><div style="text-align:center"><span style="color:#000000;font-family:Arial;font-size:13px">New Folder</span></div></button>
<button id="AdvancedButton2" type="button" name="" value="" style="position:absolute;left:917px;top:190px;width:84px;height:24px;z-index:8;"><div style="text-align:center"><span style="color:#000000;font-family:Arial;font-size:13px">Delete</span></div></button>
...
<div id="wb_BulletedList3" style="position:absolute;left:6px;top:329px;width:168px;height:40px;z-index:17;">
<div>
   <div class="bullet" style="height:20px;"><img src="../images/user.png" style="width:16px;height:16px;" alt=""></div>
   <div class="item" style="height:20px;text-align:left;"><span style="color:#000000;font-family:'Trebuchet MS';font-size:13px;">Create New User</span></div>
</div>
<div style="clear:both">
   <div class="bullet" style="height:20px;"><img src="../images/user.png" style="width:16px;height:16px;" alt=""></div>
   <div class="item" style="height:20px;text-align:left;"><a href="<?php echo site_url('user');?>"<span style="color:#000000;font-family:'Trebuchet MS';font-size:13px;">Manage User</span></div>
</div>
</div>
</div>
</body>
