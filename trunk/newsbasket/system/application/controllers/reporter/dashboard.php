...
class Dashboard extends Controller {
	...
	function home() {
		$admin['page_title'] = 'Dashboard | Reporter Newsbasket';
		$admin['username']   = $this->session->userdata['username'];
		$admin['main_view']  = 'reporter/dashboard_view';
		...
		$this->load->view('reporter/template', $admin);
	}
	...
	function myprofile() {
		...
		$data_user['page_title']		= 'Detail User | Reporter News Basket';
		$data_user['main_view'] 		= 'reporter/detail/user_detail_view';
		$data_user['user_property']		= 'reporter/detail/user_detail_property';
		$link_manage_user				= site_url('reporter/dashboard');
		$data_user['breadcrumb']		= "<a href='$link_manage_user' style='color: white;'>Dashboard</a> > My Profile";
		$data_user['form_action_edit']	= site_url('reporter/dashboard/edit_profile').'/'.$id_user;
	...
	function edit_profile($id_user) { 
		$data_user['page_title']	 	= 'Edit User | Reporter News Basket';
		$data_user['main_view'] 	 	= 'reporter/detail/editor_detail_view';
		$data_user['edit_user_form']	= 'reporter/form/edit_editor_form';
		$link_manage_user				= site_url('reporter/dashboard');
		$link_detail_user				= site_url('reporter/dashboard/myprofile');
		$data_user['breadcrumb']		= "<a href='$link_manage_user' style='color: white;'>Dashboard</a> > 
											   ...
											   > Edit Profile";
		$data_user['form_action_edit']	= site_url('reporter/dashboard/edit_profile_process').'/'.$id_user;
	...
	function edit_profile_process() {
		if ($this->session->userdata('user_level') == 'reporter' && $this->session->userdata('login') == TRUE) {
			...
			redirect('reporter/dashboard/myprofile');
		}
		else {
