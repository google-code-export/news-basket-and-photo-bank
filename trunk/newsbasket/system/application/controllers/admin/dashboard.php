...
class Dashboard extends Controller {
	...
	function myprofile() {
		...
		$link_manage_user				= site_url('admin/dashboard');
		$data_user['breadcrumb']		= "<a href='$link_manage_user' style='color: white;'>Dashboard</a> > My Profile";
		$data_user['form_action_edit']	= site_url('admin/dashboard/edit_profile').'/'.$id_user;
	...
	function edit_profile($id_user) { 
		...
		$link_manage_user				= site_url('admin/dashboard');
		$link_detail_user				= site_url('admin/dashboard/myprofile');
		$data_user['breadcrumb']		= "<a href='$link_manage_user' style='color: white;'>Dashboard</a> > 
											   ...
											   > Edit Profile";
		$data_user['form_action_edit']	= site_url('admin/dashboard/edit_profile_process').'/'.$id_user;
	...
	function edit_profile_process() {
		if ($this->session->userdata('user_level') == 'administrator' && $this->session->userdata('login') == TRUE) {
			...
			redirect('admin/dashboard/myprofile');
		}
		else {
