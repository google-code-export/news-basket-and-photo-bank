		...
		<td>&nbsp;</td>
		<p><a class="btn btn-primary" href="<?=site_url("user/upload")?>">Upload New Image</a></p>
		<td>&nbsp;</td>
		<?php if(!isset($rows)) { ?>
		...
		<tr>
			<td class="gallerypic" bgcolor="#ffffff" width="70"><a href="<?php echo base_url()."gallery/detail_foto/".$r->id_images;?>"><img src="<?php echo base_url()."images/galeri/thumbs/".$r->thumbnail;?>" /></td>
			...
			<td class="meta" bgcolor="#ffffff" width="70"><a class="btn btn-primary" href="
			<?php 
			if ($this->session->userdata('user_level') == 'administrator') {
					echo site_url("album/removeimage/".$r->id_images);
					} 
					else {
					echo site_url("album_user/removeimage/".$r->id_images);}
			?>
			">Delete</a></td>
		</tr>
		<?php endforeach; ?>
